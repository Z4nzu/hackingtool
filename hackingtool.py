...
def appcheck():
    ...
    if userchoice == 1:
        ...
        os.system("cd underhanded && bash underhanded.sh")
    elif userchoice == 99:
        socialattack()
    else :
        menu()
...
def routexp():
    print("""
        ...
        [99]Back to menu
    """)
    routerchoice=int(input("Z4nzu =>> "))
    if routerchoice == 1:
        clearScr()
        routersploit()
    elif routerchoice==99:
        menu()
    elif routerchoice==2:
        clearScr()
        fastssh()
...
def routersploit():
    ...
    ch=input("[1]Install [2]Run [99]Back :")
    if ch == 1:
...
def payloads():
    print("""
        ...
        [99]Back 
    """)
    payloadchoice =input("Z4nzu >> ")
    if payloadchoice == 1:
        clearScr()
        thefatrat()
    elif payloadchoice == 2:
        clearScr()
        Brutal()
    elif payloadchoice == 3:
        clearScr()
        stitch()
    elif payloadchoice == 4:
        clearScr()
        MSFvenom()
    elif payloadchoice == 5:
        clearScr()
        venom()
    elif payloadchoice == 6:
        clearScr()
        spycam()
    elif payloadchoice == 99:
        menu()
    elif payloadchoice == "":
        payloads()
    else :
...
def thefatrat():
    ...
    fatratchoice = input("[1]Install [2] Run [3]Update [99]Back >>  ")
    if fatratchoice == 1:
...
def Brutal():
    ...
    """)
    brutalchoice = input("[1]Install [2]Run [99]Back >> ")
    if brutalchoice == 1:
...
def stitch():
    ...
    stitchchoice = input("[1]Install [2]Run [99]Back >>" )
    if stitchchoice == 1:
...
def venom():
    ...
    venomchoice =input("[1]Install [2]Run [99]Back >> ")
    if venomchoice == 1:
