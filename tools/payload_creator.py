...
class TheFatRat(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/Screetsec/TheFatRat.git', 'cd TheFatRat && sudo chmod +x setup.sh']
...
class Brutal(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/Screetsec/Brutal.git', 'cd Brutal && sudo chmod +x Brutal.sh']
...
class Stitch(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/nathanlopez/Stitch.git', 'cd Stitch && sudo pip install -r lnx_requirements.txt']
...
class MSFVenom(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/g0tmi1k/msfpc.git', 'cd msfpc;sudo chmod +x msfpc.sh']
...
class Venom(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/r00t-3xp10it/venom.git', 'sudo chmod -R 775 venom*/ && cd venom*/ && cd aux && sudo bash setup.sh', 'sudo ./venom.sh -u']
...
class Spycam(HackingTool):
    ...
    INSTALL_COMMANDS = ['sudo git clone https://github.com/indexnotfound404/spycam.git', 'cd spycam && bash install.sh && chmod +x spycam']
